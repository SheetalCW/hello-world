...
AFTER UPDATE ON BANK_CURRENT_PROPOSAL_STATUS
   FOR EACH ROW
BEGIN
    ...
    REJECTION_DATE , bank_rejection_reason  , cw_rejection_reason, REMARK , STATUS_CODE) VALUES
    (BANK_PROPOSAL_AUDIT_LOG_SEQ.NEXTVAL , :NEW.APPLICATION_ID , :OLD.BRANCH_CODE , :OLD.BRANCH_NAME , SYSDATE , 
     ...
     :OLD.REJECTION_DATE , :OLD.bank_rejection_reason , :OLD.cw_rejection_reason , :OLD.REMARK  , :OLD.STATUS_CODE);
END;
/