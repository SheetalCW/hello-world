create or replace TRIGGER AFTR_INSERT_ON_SANCTION_DETAIL 
...
BEGIN
        ...
        ELSE 
            UPDATE BANK_CURRENT_PROPOSAL_STATUS BCPS SET BCPS.bank_curr_proposal_status_id = statusId , BCPS.BRANCH_CODE = branchCode ,IS_SAVED = :NEW.IS_SAVED  ,
             BCPS.REMARK = :NEW.REMARK  , BCPS.MODIFIED_BY = :NEW.CREATED_BY  , BCPS.MODIFIED_DATE = SYSDATE bcps.sanction_pk = :NEW.id , 
