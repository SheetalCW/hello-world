...
public class AuditComponent {
	...
	public static final int GENERATING_TOKEN = 1;
	...
	/*
	 * public static final int PRELIM_INFO = 1; public static final int
	 * DETAILED_INFO = 2; public static final int SCORING_DETAILS = 3; public static
	 * final int IRR_DETAILS = 4; public static final int DDR_DETAILS = 5; public
	 * static final int BANK_STATEMENT = 6; public static final int
	 * MATCHES_PARAMETER = 7;
	 * 
	 * public static final int FINANCIAL_DETAILS = 9; public static final int
	 * CMA_DETAIL = 12; public static final int LOGIC_DETAIL = 13; public static
	 * final int COMMERCIAL_CIBIL = 14; public static final int
	 * SANCTION_AND_DISBURSEMENT = 15; public static final int
	 * UPDATE_PROPOSAL_STATUS_LOAN_MASTER = 16;
	 * 
	 * public static final int CGTMSE_DETAIL = 21; public static final int
	 * GST_DETAIL = 22; public static final int FINAL_DISPLAY = 24; public static
	 * final int ADDITIONAL_DETAIL = 25;
	 */
